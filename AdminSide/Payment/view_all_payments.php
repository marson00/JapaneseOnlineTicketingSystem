...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini dark-mode layout-fixed layout-navbar-fixed">
                        ...
                        <div class="card-body">
                            <div class="row table-responsive">
                                ...
                                <table id="paymentsTable" 
                                       ...
                                       role="grid" aria-describedby="all_payments_info">
                                    <colgroup>
                                        <col width="25%">
                                        <col width="25%">
                                        <col width="25%">
        ...
        <script src="../../dataTable/view_payments_jquery.js" type="text/javascript"></script>
        <script>
            $(function () {
                showMenuSelected("#payment", "#view_payment");
            });
        </script>
        <!-- JavaScript -->
