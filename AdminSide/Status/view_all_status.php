...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini dark-mode layout-fixed layout-navbar-fixed">
                        ...
                        <div class="card-body">
                            <div class="row table-responsive">
                                ...
                                <table id="statusTable" 
                                       ...
                                       role="grid" aria-describedby="all_status_info">
                                    <colgroup>
                                        <col width="10%">
                                        <col width="70%">
                                        <col width="20%">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="p-1 text-center">Status title</th>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <a href="/JapaneseOnlineTicketingSystem/AdminSide/Status/add_status.php" class="btn btn-primary btn-sm btn-flat mb-1">
                                                            <span class="mr-2">Add Status</span><i class="fa fa-plus"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
        ...
        <script src="../../dataTable/view_status_jquery.js" type="text/javascript"></script>
        <script src="../../config/msgHandler.js" type="text/javascript"></script>
        <script>
            $(function () {
                showMenuSelected("#status", "#view_status");
            })
        </script>
        <!-- JavaScript -->
