    ...
    <body class="hold-transition sidebar-mini dark-mode layout-fixed layout-navbar-fixed">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content (Display Categories) -->
        ...
        <script src="../../dataTable/view_category_jquery.js" type="text/javascript"></script>
        <script src="../../config/msgHandler.js" type="text/javascript"></script>
        <script>
            $(function () {
                showMenuSelected("#categories", "#view_all_categories");
            });
        </script>
        <!-- Script -->
